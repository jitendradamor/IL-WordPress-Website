    ...
    if(isset($_POST['user-registeration']) && $_POST['user-registeration'] == 'SignUp' ) {
        ...
        if( $email == "" || $password == "" || $username == "" || $country == "") {
            ...
            if( is_wp_error($user_id) ) {
                ...
                $_SESSION['msg'] = 'Congratulations! Your account has been created successfully.';
...
<div id="content">
    ...
    <?php if(isset($error)){echo '<div class="form-error">'.$error.'</div>';}?>
        ...
        <input type="text" name="username" placeholder="Enter Your Username" class="text" /><br />
        <label>Email address <span class="error">*</span></label>
        <input type="email" name="useremail" class="text" placeholder="Enter Your Email"  /> <br />
        <label>Password <span class="error">*</span></label>
        <input type="password" name="password" class="text" placeholder="Enter Your password"  /> <br />
        <label>Country of Residence <span class="error">*</span></label>
        <input type="text" name="country-of-residence" class="text" placeholder="Country of Residence"  /> <br />
